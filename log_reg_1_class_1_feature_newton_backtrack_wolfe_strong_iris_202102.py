...
if len(sys.argv)!=9:
    print("Use:  log_reg_1_class_1_feature_newton_backtrack_wolfe_strong_iris_202102.py <features> <target> <#iterations newton> <absolute tolerance> <lift coeff c1> <coeff c2> <gamma c> <#iterations bt>",file=sys.stderr)
    sys.exit(1)
