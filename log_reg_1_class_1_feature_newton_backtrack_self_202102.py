...
if len(sys.argv)!=8:
    print("Use: log_reg_1_class_1_feature_newton_backtrack_self_202102.py <features> <target> <#iterations newton> <absolute tolerance> <lift coeff c> <gamma c> <#iterations bt>",file=sys.stderr)
    sys.exit(1)
